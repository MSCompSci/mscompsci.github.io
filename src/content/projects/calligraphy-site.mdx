...
<figure>
  <ZoomImg client:load src="/src/images/calligraphy-site/sample-wireframes.png" alt="" class="bg-white p-4"/>
...
<figure>
  <ZoomImg client:load src="/src/images/calligraphy-site/map.png" alt="" class="bg-white p-4"/>
