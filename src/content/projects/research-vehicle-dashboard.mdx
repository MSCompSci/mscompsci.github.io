...
import Page from '@images/dashboard/page.png'
import Post from '@images/dashboard/poster.png'
import Ads from '@images/dashboard/ads.png'
import Vehicle from '@images/dashboard/RO3QET.jpg'

<figure>
    <ZoomImg client:load>
    <Image  loading="eager" client:load slot="image" src={Page} alt="" />
    <Image client:load slot="expanded-image" src={Page} alt="" />
  </ZoomImg>
...
<figure>
    <ZoomImg client:load>
    <Image client:load slot="image" src={Vehicle} alt="" />
    <Image client:load slot="expanded-image" src={Vehicle} alt="" />
  </ZoomImg>
...
<figure>
    <ZoomImg client:load>
    <Image client:load slot="image" src={Page} alt="" />
    <Image client:load slot="expanded-image" src={Page} alt="" />
  </ZoomImg>
  <figcaption>The dashboard for the RO3QET research vehicle</figcaption>
</figure>
...
<figure>
      <ZoomImg client:load>
    <Image client:load slot="image" src={Post} alt="" />
    <Image client:load slot="expanded-image" src={Post} alt="" />
  </ZoomImg>
...
<figure>
      <ZoomImg client:load>
    <Image client:load slot="image" src={Ads} alt="" />
    <Image client:load slot="expanded-image" src={Ads} alt="" />
  </ZoomImg>
  <figcaption>The research abstract <a target="_blank" href="https://ui.adsabs.harvard.edu/">(via the Harvard Astrophysics Data System)</a> </figcaption>
</figure>
